...
ALTER TABLE doc_categories DROP CONSTRAINT IF EXISTS doc_categories_name_parent_unique;
ALTER TABLE doc_categories DROP CONSTRAINT IF EXISTS doc_categories_slug_parent_unique;
